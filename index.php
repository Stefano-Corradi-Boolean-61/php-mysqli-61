...
<div class="container">
  <?php if($offset > 0): ?>
<a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/php-mysqli/index.php?offset=<?php echo $offset - $limit ?>" class="btn btn-info"><< indietro</a>
<?php endif; ?>
  <a href="http://<?php echo $_SERVER['HTTP_HOST'] ?>/php-mysqli/index.php?offset=<?php echo $offset + $limit ?>" class="btn btn-info">avanti >></a>
</div>
